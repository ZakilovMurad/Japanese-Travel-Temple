...
gsap.from('.home__img-6', {duration: 1.5 , opacity: 0, y:200, delay: .1, ease: 'back.out(1.5)'})
gsap.from('.home__img-3', {duration: 1.5 , opacity: 0, y:400, delay: .3, ease: 'back.out(1.5)'})
gsap.from('.home__img-5', {duration: 1.5 , opacity: 0, y:400, delay: .5, ease: 'back.out(1.5)'})
gsap.from('.home__img-2', {duration: 1.5 , opacity: 0, y:400, delay: .8, ease: 'back.out(1.5)'})
